	...
	<div class="section-main child-page">
		...
		<div class="container padding50px">
			...
			@if(@$app_info)
				...
				<div class="row">
					<div class="col-sm-1"></div>
					<div class="col-sm-10">{{ $app_info['app_description'] }}</div>
					<div class="col-sm-1"></div>
				</div>
			@endif
		</div>
